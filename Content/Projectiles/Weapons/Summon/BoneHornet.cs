...
{
	public class BoneHornet : ModProjectile
	{
		...
		public override void AI()
		{
			...
			{
				player.ClearBuff(ModContent.BuffType<Buffs.Minions.BoneHornet>());
			}
			if (player.HasBuff(ModContent.BuffType<Buffs.Minions.BoneHornet>()))
			{
			...
			int new_projectile_type = ProjectileID.BoneGloveProj;
